...
Description: A plugin to add a custom footer to your wordpress site.
Version: 1.0
Author: said
...
function custom_plugin_setting_page()
{
	...
	add_menu_page('Custom Plugin', 'Footer Setting', 'manage_options', 'custom-plugin-setting-url',
		'custom_page_html_form', plugins_url('custom-plugin/img/icon.png'));
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        <input type='text' class="regular-text" id="first_field_id" name="email" value="<?php
                ...
                <tr>
                    ...
                    <td>
                        <input type='text' class="regular-text" id="second_field_id" name="copyright" value="<?php
                ...
                <tr>
                    ...
                    <td>
                        <input type='text' class="regular-text" id="third_field_id" name="facebook_url" value="<?php
                ...
                <tr>
                    ...
                    <td>
                        <input type='text' class="regular-text" id="fourth_field_id" name="twitter_url" value="<?php
                ...
                <tr>
                    ...
                    <td>
                        <input type='text' class="regular-text" id="fifth_field_id" name="linkedin_url" value="<?php
